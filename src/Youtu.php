...
class Youtu {
    ...
    //身份证OCR识别
    const YOUTU_IDCARD_URL = 'https://api.youtu.qq.com/youtu/ocrapi/idcardocr';
    ...
    public function creditcardocr ($image_path) {
        ...
        $postUrl = self::YOUTU_CREDITCARDOCR_URL;
        $sign = $this->appSign ();
...
//        $this->http_info = curl_getinfo ($curlHandle);
     ...
     * @return string
     * @author   xiaole
     * @time     17/11/24 下午2:48
     */
    private function appSign ($expired = '2592000') {
